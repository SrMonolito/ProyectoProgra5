...
namespace ProjectoProgra5.Pages
{
    public partial class ListarClientes : System.Web.UI.Page
    {
                ...
                using (ProyectoProgra5Entities db = new ProyectoProgra5Entities())
                {
                    ...
                    if (id != "")
                    {
                        ...
                        if (idi != 0)
                        {
                            ...
                            var Info = db.SP_Buscar_Cliente_por_Id(idi).ToList();
                            //cargamos los datos de la variable Info en el gridview
                            GvListaClientes.DataSource = Info;
        ...
        {
            Response.Redirect("~/Pages/GuardarClientePage");
        }
        ...
        private void CargarInfo()
        {
            try
            {
                ...
                {
                    //llamamos al procedimiento y almacenamos los datos en una variable
                    var Info = db.SP_Listar_Clientes().ToList();
                    //cargamos los datos de la variable Info en el gridview
                    GvListaClientes.DataSource = Info;
                    GvListaClientes.DataBind();
                }
